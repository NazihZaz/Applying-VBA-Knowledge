...
The VBA script allows to loop through all the stocks for each year and output the information below. Note that the script is the same for 2014, 2015 and 2016 and there is no need to adapt it.
...
Below are screenshots of the output in Excel using The VBA of Wall Street_VBA Script.